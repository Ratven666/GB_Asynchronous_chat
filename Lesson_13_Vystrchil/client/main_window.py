...
sys.path.append('../')
from Lesson_13_Vystrchil.client.main_window_conv import Ui_MainClientWindow
from Lesson_13_Vystrchil.client.add_contact import AddContactDialog
from Lesson_13_Vystrchil.client.del_contact import DelContactDialog
from Lesson_13_Vystrchil.client.database import ClientDatabase
