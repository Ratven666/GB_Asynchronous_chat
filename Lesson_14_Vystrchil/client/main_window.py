...
sys.path.append('../')
from Lesson_14_Vystrchil.client.main_window_conv import Ui_MainClientWindow
from Lesson_14_Vystrchil.client.add_contact import AddContactDialog
from Lesson_14_Vystrchil.client.del_contact import DelContactDialog
